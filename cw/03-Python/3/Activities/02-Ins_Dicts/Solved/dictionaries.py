...
# A dictionary can even contain another dictionary (another example) (even with index numbers)
film = {
    "title": "Interstellar",
    "revenues": {
        "United States": 
            {"NJ":120, "NY":[100,{"ABC":150, "XYZ":20}, 300]},
        "China": 250,
        "United Kingdom": 73
    }
}
print(f'{film["title"]} made {film["revenues"]["United States"]["NY"][1]["XYZ"]}'" million dollars in the US.")